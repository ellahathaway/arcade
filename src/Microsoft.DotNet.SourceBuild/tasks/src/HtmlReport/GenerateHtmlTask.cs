...
// using Microsoft.DotNet.SourceBuild.Tasks.HtmlReport;
...
// // public class MyComponentWrapper : IComponent
// // {
...
// //     {
// //         builder.OpenComponent(0, typeof(PrebuiltReport));
// //         builder.AddAttribute(1, "Repos", Repos);
